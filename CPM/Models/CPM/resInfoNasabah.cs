...
public class resInfoNasabah
{
    public DateTime? TGL_SALDO { get; set; }
    public string NO_NAS { get; set; }
    public string NM_NAS { get; set; }
    public string JNS_IDENT { get; set; }
    public string NO_IDENT { get; set; }
    public int MASA_IDENT { get; set; }
    public DateTime? TGL_LAKU_SAMPAI { get; set; }
    ...
    public string KD_KOTA1 { get; set; }
    public string PROPINSI { get; set; }
    public string KD_POS { get; set; }
    public string NEGARA { get; set; }
    public string KD_KOTA2 { get; set; }
    public string NEG { get; set; }
    public string KD_NEG { get; set; }
    ...
    public string FLAG_TIPE_NAS { get; set; }
    public string NM_TIPE_NAS { get; set; }
    public string KD_STS_NAS { get; set; }
